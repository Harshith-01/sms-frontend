...
// ✅ Connect to Attendance Service
const api = createAPI(import.meta.env.VITE_ATTENDANCE_SERVICE);

// ==================== TIMETABLE PERIODS ====================
export const getTimetablePeriods = async (class_section_id, academic_term_id) => {
  return api.get(
    `/timetable-attendance/periods?class_section_id=${class_section_id}&academic_term_id=${academic_term_id}`
  );
};
...
export const getTimetableEntries = async (class_section_id, academic_term_id) => {
  return api.get(
    `/timetable-attendance/entries/class/${class_section_id}?academic_term_id=${academic_term_id}`
  );
};
...
export const getAttendanceSetting = async (class_section_id) => {
  return api.get(
    `/timetable-attendance/attendance/settings/${class_section_id}`
  );
};
...
export const bulkUpsertAbsences = async (session_id, data) => {
  return api.post(
    `/timetable-attendance/attendance/sessions/${session_id}/absences/bulk`,
    data
  );
};
...
export const getStudentAttendanceHistory = async (student_id) => {
  return api.get(
    `/timetable-attendance/attendance/students/${student_id}/history`
  );
};
...
export const getStudentAttendanceSummary = async (
  ...
  return api.get(
    `/timetable-attendance/attendance/students/${student_id}/summary?class_section_id=${class_section_id}&academic_term_id=${academic_term_id}`
  );
};
...
export const getClassAttendanceAnalytics = async (
  ...
  return api.get(
    `/timetable-attendance/attendance/analytics/class/${class_section_id}?academic_term_id=${academic_term_id}`
  );
};

export const getSchoolAttendanceAnalytics = async (academic_term_id) => {
  return api.get(
    `/timetable-attendance/attendance/analytics/school?academic_term_id=${academic_term_id}`
  );
};