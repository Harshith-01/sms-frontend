...
// ✅ Create API instance for Academic Service
const api = axios.create({
  baseURL: import.meta.env.VITE_ACADEMIC_SERVICE,
  headers: {
...
export const createAcademicYear = (data) =>
  api.post("/academic/academic-years", data);
export const updateAcademicYear = (id, data) =>
  api.patch(`/academic/academic-years/${id}`, data);
export const deleteAcademicYear = (id) =>
  api.delete(`/academic/academic-years/${id}`);
...
export const getAcademicTerms = (filters = {}) => {
  ...
  if (filters.is_current !== undefined)
    params.append("is_current", filters.is_current);

  return api.get(`/academic/academic-terms?${params.toString()}`);
};

export const createAcademicTerm = (data) =>
  api.post("/academic/academic-terms", data);
export const updateAcademicTerm = (id, data) =>
  api.patch(`/academic/academic-terms/${id}`, data);
export const deleteAcademicTerm = (id) =>
  api.delete(`/academic/academic-terms/${id}`);
...
export const deleteSection = (id) =>
  api.delete(`/academic/sections/${id}`);

// ==================== CLASS SECTIONS ====================
export const getClassSections = () =>
  api.get("/academic/class-sections");
export const createClassSection = (data) =>
  api.post("/academic/class-sections", data);
export const updateClassSection = (id, data) =>
  api.patch(`/academic/class-sections/${id}`, data);
export const deleteClassSection = (id) =>
  api.delete(`/academic/class-sections/${id}`);
...
export const createTeachingAssignment = (data) =>
  api.post("/academic/teaching-assignments", data);
export const deleteTeachingAssignment = (id) =>
  api.delete(`/academic/teaching-assignments/${id}`);
...
export const getStudentEnrollments = (filters = {}) => {
  ...
  if (filters.class_section_id)
    params.append("class_section_id", filters.class_section_id);
  if (filters.academic_year_id)
    params.append("academic_year_id", filters.academic_year_id);

  return api.get(
    `/academic/student-subject-enrollments?${params.toString()}`
  );
};

export const createStudentEnrollment = (data) =>
  api.post("/academic/student-subject-enrollments", data);
export const deleteStudentEnrollment = (id) =>
  api.delete(`/academic/student-subject-enrollments/${id}`);

// ==================== HOLIDAYS ====================
export const getHolidays = (academic_year_id = null) => {
  const params = new URLSearchParams();
  if (academic_year_id)
    params.append("academic_year_id", academic_year_id);

  return api.get(`/academic/holidays?${params.toString()}`);
};

export const createHoliday = (data) =>
  api.post("/academic/holidays", data);
export const deleteHoliday = (id) =>
  api.delete(`/academic/holidays/${id}`);

// ==================== SCHOOL SETTINGS ====================
export const getSchoolSettings = () =>
  api.get("/academic/school-settings");

export const updateSchoolSettings = (data) =>
  api.put("/academic/school-settings", data);