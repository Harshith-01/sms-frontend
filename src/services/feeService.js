...
// ==================== FEE PAYMENTS ====================
export const getFeePayments = (filters = {}, page = 1, pageSize = 20) => {
  const params = new URLSearchParams({ page, page_size: pageSize });
